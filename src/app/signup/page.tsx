...
export default function SignupPage(){
    ...
    return (
        <div className="flex flex-col items-center justify-center py-2 min-h-screen">
            <h1 className="font-black uppercase text-amber-300 text-6xl tracking-tighter">{loading ? "Processing" : "Signup"}</h1>
            <hr />
            ...
            <button
                ...
                onClick={onSignup}
            > {buttonDisabled ? "Fill all fields" : "Signup here"} </button>
